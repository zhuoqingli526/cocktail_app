class FollowRequestsController < ApplicationController
  ...
  def create
    ...
    if the_follow_request.valid?
      ...
      redirect_to("/users/#{the_follow_request.recipient_id}", { :notice => "Followed successfully." })
    else
      redirect_to("/users/#{the_follow_request.recipient_id}", { :alert => the_follow_request.errors.full_messages.to_sentence })
    end
  end
  ...
  def destroy
    ...
    redirect_to("/users/#{recipient_id}", { :notice  => "Unfollowed successfully." })
  end
end
